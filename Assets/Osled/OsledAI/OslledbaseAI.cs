...
public class ScannedRobotEvent1
{
    public string Name;
    public float Distance;
}
public class OslledbaseAI : MonoBehaviour
{
    public Pirateshiposledcontroller Ship = null;

    // Events
    public virtual void OnScannedRobot1(ScannedRobotEvent1 e)
    {
        // 
    }
