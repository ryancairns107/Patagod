...
public class ScannedRobotEvent2
{
    public string Name;
    public float Distance;
}

public class JeroBaseAI : MonoBehaviour
{
    public JeroShipController Ship = null;

    // Events
    public virtual void OnScannedRobot2(ScannedRobotEvent2 e)
    {
        // 
    }
