...
public class JeroShipController : MonoBehaviour
{
    ...
    public void SetAI(JeroBaseAI _ai)
    {
        ai = _ai;
        ai.Ship = this;
    }
    ...
    void OnTriggerStay(Collider other)
    {
        if (other.tag == "Boat")
        {
            ScannedRobotEvent2 scannedRobotEvent2 = new ScannedRobotEvent2();
            scannedRobotEvent2.Distance = Vector3.Distance(transform.position, other.transform.position);
            scannedRobotEvent2.Name = other.name;
            ai.OnScannedRobot2(scannedRobotEvent2);
        }
    }
